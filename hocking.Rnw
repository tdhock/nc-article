...
\pkg{data.table} have smaller asymptotic slopes (0.91--1.08) than the
other packages (1.85--2.15). These data suggest that the computation
time of \pkg{nc} and \pkg{data.table} is linear $O(C)$ for $C$
columns, whereas the other packages are quadratic $O(C^2)$.
...
%% 1:                1 nc::capture_melt_multiple -4.196213 0.9198872
%% 2:                0 nc::capture_melt_multiple -4.587477 1.0200630
%% 3:                0          data.table::melt -5.199096 1.0845269
%% 4:                1       tidyr::pivot_longer -7.471493 1.8536051
%% 5:                0       tidyr::pivot_longer -7.669319 1.8885024
%% 6:                0            stats::reshape -7.171669 2.0554691
%% 7:                0  cdata::rowrecs_to_blocks -7.233112 2.1561142
%% > 
...
reshape output columns and a variable number of reshape input columns
...
large $C$ we observed that \pkg{nc} and its dependent package
\pkg{data.table} were linear $O(C)$, which was much faster than the
other packages which were quadratic $O(C^2)$ (\pkg{cdata},
\pkg{stats}, \pkg{tidyr}). This result suggests that the speed of
