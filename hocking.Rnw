...
In this section we investigate the relative speed of several data
reshaping packages. detailed timing measurements, in

\begin{figure}
  \centering
  \includegraphics[width = \textwidth]{figure-who-rows.pdf}
  \caption{Timings fixed 56 columns, varying rows.}
  \label{fig:timings}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width = \textwidth]{figure-who-complex-rows.pdf}
  \caption{Timings fixed 56 columns, varying rows, type conversion.}
  \label{fig:timings}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width = \textwidth]{figure-who-cols.pdf}
  \caption{Timings fixed 7240 rows, varying columns.}
  \label{fig:timings}
\end{figure}
